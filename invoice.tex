...
%--------------------------------
\usepackage{geometry} 
\geometry{$geometry$, top=4.5cm, left=2.5cm, footskip=0cm}
% Footer
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
...
$else$
  ...
  \section*{\textsc{Rechnung} \textsc{\#\ifnum $date.year$=2020 20\else \StrSubstitute{$date.year$}{20}{} \fi
...
\cfoot{
  ...
  \begin{tabularx}{\linewidth}{lXXl}
    ...
    $from$ & E-Mail: $author.email$ & Inhaber: $bank.owner$ & $author.taxnumber$\\
    abc& Internet: $author.website$ & IBAN: $bank.iban$ & \\
    && BIC: $bank.bic$&
  \end{tabularx}
}
